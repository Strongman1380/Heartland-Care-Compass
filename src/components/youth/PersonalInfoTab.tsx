...
export const PersonalInfoTab = ({ formData, handleChange, handleSelectChange, handlePhotoUpload, profilePhoto }: PersonalInfoTabProps) => {
  ...
  const handleExportProfile = async () => {
    try {
      ...
      await generateProfilePDF(youthData);
      toast.success("Profile PDF exported successfully");
    } catch (error) {
      console.error('Error exporting profile:', error);
      toast.error("Failed to export profile PDF");
    }
  };
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Select name="sex" onValueChange={value => handleSelectChange("sex", value)}>
                  <SelectTrigger>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="guardianAdLitemName">Guardian ad Litem</Label>
                <Input 
                  id="guardianAdLitemName" 
                  name="guardianAdLitemName" 
                  placeholder="Full name"
                  onChange={handleChange} 
                />
              </div>
