...
export const MentalHealthProfileTab = ({ youth, onYouthUpdated }: MentalHealthProfileTabProps) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="font-semibold text-red-800 mb-4">Mental Health Information</h3>
      ...
      <div>
        ...
        <div className="space-y-1">
          <EditableField
            label="Risk Level"
            value={youth.hyrnaRiskLevel}
            onSave={(value) => handleFieldUpdate('hyrnaRiskLevel', value)}
            type="select"
            options={riskLevelOptions}
          />
          <EditableField
            label="HYRNA Score"
            value={youth.hyrnaScore}
            onSave={(value) => handleFieldUpdate('hyrnaScore', value)}
            type="number"
          />
          <EditableField
            label="Assessment Date"
            value={formatDateForInput(youth.hyrnaAssessmentDate)}
            onSave={(value) => handleFieldUpdate('hyrnaAssessmentDate', value)}
            type="date"
          />
        </div>
      </div>
