...
export const MonthlyProgressReportPage = () => {
              ...
              <div className="max-w-md">
                ...
                <Select value={selectedYouthId} onValueChange={handleYouthChange}>
                  <SelectTrigger className="mt-1">
                    <SelectValue placeholder="Choose a youth for the report" />
                  </SelectTrigger>
                  <SelectContent>
                    {youths.map((youth) => (
              ...
              <CardContent className="p-8 text-center">
                <p className="text-gray-500">
                  {youths.length === 0 
                    ...
                    : "Please select a youth to generate their monthly progress report."
                  }
                </p>
              </CardContent>
            </Card>
