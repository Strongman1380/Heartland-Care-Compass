...
export const generateReportHTML = async (youth: Youth, options: ReportOptions): Promise<string> => {
  ...
  const profileFormSection = () => {
    ...
    const photoBox = (() => {
      ...
      return `<div style="width:144pt; height:180pt; border:1pt solid #000; display:flex; align-items:center; justify-content:center; font-size:10pt; color:#555;">Photo</div>`;
    })();
