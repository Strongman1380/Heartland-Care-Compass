...
export default function LocalEditYouthDialog({ youth, open, onClose, onSuccess }: Props) {
  ...
  const { formData, setFormData, handleChange, handleSelectChange, handleCheckboxChange } = useYouthForm();
        ...
        <form onSubmit={onSubmit} className="space-y-4 py-2">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="personal">
              <PersonalInfoTab formData={formData} handleChange={handleChange} handleSelectChange={handleSelectChange} />
            </TabsContent>
