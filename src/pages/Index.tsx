      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-yellow-300 p-6 mb-6">
          <div className="text-center">
            ...
            <p className="text-red-600 text-lg mb-6">Use the navigation menu above to access different features for managing youth programs.</p>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="analysis">
            <BehaviorAnalysis youthId={null} youth={null} />
          </TabsContent>
          
          <TabsContent value="assessment">
            <RiskAssessment youthId={null} youth={null} />
          </TabsContent>
