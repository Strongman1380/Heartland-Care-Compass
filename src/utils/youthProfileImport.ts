...
export function mapImportedProfileToFormPatch(parsedData: AnyRecord): Partial<YouthFormData> {
  ...
  const stringMappings: Array<{ formKey: keyof YouthFormData; values: any[] }> = [
    ...
    { formKey: "guardianLanguage", values: [parsedData.guardianLanguage] },
    { formKey: "placingAgencyCounty", values: [parsedData.placingAgencyCounty] },
    { formKey: "district", values: [parsedData.district] },
    ...
    { formKey: "referralReason", values: [firstDefined(parsedData, ["referralReason", "reasonForPlacement"])] },
    { formKey: "reasonForPlacement", values: [firstDefined(parsedData, ["reasonForPlacement", "referralReason"])] },
    { formKey: "immediateNeeds", values: [parsedData.immediateNeeds] },
    { formKey: "intakeObservation", values: [parsedData.intakeObservation] },
    { formKey: "orientationCompletedBy", values: [parsedData.orientationCompletedBy] },
    ...
    { formKey: "drugTestingDates", values: [firstDefined(parsedData, ["drugTestingDates", "drugUATesting"])] },
    ...
    { formKey: "dischargeNotes", values: [firstDefined(parsedData, ["dischargeNotes", "dischargePlan"])] },
  ...
  const boolMappings: Array<{ formKey: keyof YouthFormData; value: any }> = [
    ...
    { formKey: "parentsNotifiedOfPlacement", value: parsedData.parentsNotifiedOfPlacement },
    // Risk & Recovery
