  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-yellow-50 to-red-100">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {selectedYouthId ? (
          <BehaviorCard youthId={selectedYouthId} youth={{ id: selectedYouthId }} />
        ) : (
          <div className="bg-white p-8 rounded-lg shadow-lg text-center border-2 border-yellow-300">
            ...
            <p className="text-red-600 text-lg">Please select a youth from the dropdown above to manage their daily points.</p>
          </div>
        )}
      </main>
    </div>
